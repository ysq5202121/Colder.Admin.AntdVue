          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="WeChatId">微信用户ID</a-select-option>
                <a-select-option key="Remark">备注信息</a-select-option>
                <a-select-option key="Department">部门名称</a-select-option>
                <a-select-option key="ImgUrl">用户头像</a-select-option>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/ServerReport/RP_UserInfo/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/ServerReport/RP_UserInfo/DeleteData', ids).then(resJson => {
              resolve()
