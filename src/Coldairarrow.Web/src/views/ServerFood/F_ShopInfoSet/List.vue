  ...
  <a-card :bordered="false">
    <div class="table-operator">
      <a-button
        ...
        :loading="loading"
        v-if="hasPerm('F_ShopInfoSet.Delete')"
      >删除</a-button>
    ...
    >
      <span slot="action" slot-scope="text, record">
        <template>
          ...
          <a-divider type="vertical"  v-if="hasPerm('F_ShopInfoSet.Delete')"/>
          <a @click="handleDelete([record.Id])" v-if="hasPerm('F_ShopInfoSet.Delete')">删除</a>
        </template>
      </span>
    </a-table>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/ServerFood/F_ShopInfoSet/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/ServerFood/F_ShopInfoSet/DeleteData', ids).then(resJson => {
              resolve()
